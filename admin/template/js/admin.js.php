...
function createCKEditor(name, toolbarSet, width, height, params)
{
	var toolbars = {
        ...
        standart: [
            ['Source', '-', 'Maximize', '-', 'Templates', 'Blockquote', 'Blockquote2', 'toc'],
            ['Cut', 'Copy', 'Paste', 'PasteText', 'PasteFromWord', '-', 'Undo', 'Redo'],
            ['Find', 'Replace', '-', 'SelectAll'],
            ['Link', 'Unlink', 'Anchor'],
            ['Image', 'Flash', 'Table', 'HorizontalRule', 'SpecialChar', 'Iframe', 'InsertArticle', 'InsertCarousel'], '/',
            ['Format', 'FontSize', '-', 'Bold', 'Italic', 'Underline', 'Strike', 'Subscript', 'Superscript', '-', 'RemoveFormat'],
            ['NumberedList', 'BulletedList', '-', 'Outdent', 'Indent', '-', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyBlock']
        ],
        articleEditor: [
            ['Source', '-', 'Maximize', '-', 'Blockquote', 'Blockquote2'],
            ['Undo', 'Redo'],
            ['Link', 'Unlink'],
 	...
 	cfg = new Object({
		...
		width: width || '100%',
		height : height || '400px',
        fontSize_sizes : 'Small/8px;Large/20px;',
	...
	//Extra plugins
    CKEDITOR.config.extraPlugins = 'toc,article,blockquote2,carousel,liststyle2';
