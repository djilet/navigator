...
jQuery(function($) {
    ...
    ULTRA_SETTINGS.otherScripts = function() {
        ...
        if ($.isFunction($.fn.datetimepicker)) {
            ...
            $('.datepickerforvk').datetimepicker({
                language:  'ru',
                format: "yyyy-mm-dd",
                weekStart: 1,
                todayBtn: 1,
        ...
        if ($.isFunction($.fn.timepicker)) {
            $(".timepicker").each(function(i, e) {
                var $this = $(e),
                    options = {
                        template: getValue($this, 'template', 'dropdown'),
                        showSeconds: getValue($this, 'showSeconds', false),
                        defaultTime: getValue($this, 'defaultTime', '1:00'),
                        showMeridian: getValue($this, 'showMeridian', false),
