...
class OrderList extends LocalObjectList
{
	...
	public function exportToCSV(){
        ...
        $row = array("Дата заявки", "Имя", "Фамилия", "Телефон", "Статус", "Класс", "Страны", "Город", "Способ связи", "Дополнительно", "Лендинг", "UTM source", "UTM medium", "UTM campaign", "UTM term", "UTM content");
        fputcsv($f, $row, ";");
