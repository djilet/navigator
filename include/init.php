...
define("PATH2MAIN", PROJECT_PATH."website/".WEBSITE_FOLDER."/template/");
...
define("ONLINEEVENT", "onlineevent");
define("PARTNER", "partner");
define("API_SCANNER", "api-scanner");
define("API_SCANNER_FULL", "api-scanner-full");
define("CONSULTANT", "consultant");
define("PROFTEST", "proftest");
define("ROLE_UNIVERSITY", "university");
