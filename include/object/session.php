...
class Session extends BaseObject
{
	...
	function UpdateCookie($cookieInterval)
	{
		...
		if ($this->_inCookie)
			setcookie($this->_sessionName, $this->_sessionID, time()+$cookieInterval, PROJECT_PATH, GetFromConfig('Domain', 'server'));
		else
			setcookie($this->_sessionName, $this->_sessionID, 0, PROJECT_PATH, GetFromConfig('Domain', 'server'));
